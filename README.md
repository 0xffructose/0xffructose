<h1 align="center">Hi, I'm 0xffruktoz 👋</h1>
<p align="center">Systems & Graphics Programmer · Game Dev Enthusiast · Building in Web2 & Web3</p>

---

### 🔧 What I do

I build low-level, performance-oriented software — physics simulations, custom stacks, and rendering systems. I like getting close to the metal and understanding how things actually work under the hood, rather than just gluing libraries together.

- 🦀 **Systems programming** in Rust, C, and C++
- 🎮 **Game & simulation dev** — physics engines, particle systems, procedural behavior
- 🖼️ **Graphics** — building renderers from scratch
- 🌐 **Web3** — exploring builder grants and on-chain tooling
...
- Shipping **TypeVoyage**, a game for CrazyGames
- A node-health monitoring tool for the **Avalanche Team1 Builder Grants** program
- Exploring new memory models for AI agents
